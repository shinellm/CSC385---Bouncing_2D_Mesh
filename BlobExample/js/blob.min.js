var BlobWorld = new (function () {
    function b(f, h) {
        var d = new Blob;    //Create a blob and set it to variable d
        d.position.x = f.x;  //Set the x position of the blob
        d.position.y = f.y;  //Set the y position of the blob
        d.velocity.x = h.x;  //Set the velocity of the blob's x position
        d.velocity.y = h.y;
        d.generateNodes();
        j.push(d)
    }
